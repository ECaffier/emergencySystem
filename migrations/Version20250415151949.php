...
{
    // Création des tables (déjà présent dans ton code)
    $this->addSql(<<<'SQL'
    ...
    $this->addSql("INSERT INTO operator (name) VALUES ('Opérateur de test')");
    // Insertion d'une équipe
    $this->addSql("INSERT INTO team (type, availability) VALUES ('Équipe Alpha', 1)");
    // Insertion d'un appelant
    $this->addSql("INSERT INTO caller (name, phone) VALUES ('Jean Dupont', '0601020304')");
}
